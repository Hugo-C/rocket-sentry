...
- **CI:** Fix clippy checks in CI ([#72](https://github.com/Hugo-C/rocket-sentry/pull/72))
- **Feature:** Add `#[must_use]` to RocketSentry::fairing() ([#69](https://github.com/Hugo-C/rocket-sentry/pull/69))
